...
//	private String manageCategory;// 管理分类
	@JsonProperty(value = "PRODTOLIST")
	private List<SapProListPara> PRODTOLIST = new ArrayList<SapProListPara>();//商品列表

	public List<SapProListPara> getPRODTOLIST() {
		return PRODTOLIST;
	}

	public void setPRODTOLIST(List<SapProListPara> pRODTOLIST) {
