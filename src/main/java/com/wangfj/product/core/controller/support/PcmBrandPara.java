...
public class PcmBrandPara extends BasePara {
	...
	@NotNull(message = "{PcmBrandPara.brandSid.isNotNull}")
	private String brandSid;// 品牌编码

	@NotNull(message = "{PcmBrandPara.brandName.isNotNull}")
	private String brandName;// 品牌名称

	@Pattern(regexp = "^[A-Za-z]+$", message = "{PcmBrandPara.spell.isNotLetter}")
	...
	@Pattern(regexp = "^[A-Za-z]+$", message = "{PcmBrandPara.brandNameEn.isNotLetter}")
